---
name: pptx
description: "Create a PowerPoint (.pptx) deck from the member's request or source material with python-pptx, save it under output/ and hand back a download link. Use when the member asks for a PPT, PowerPoint, slide deck or presentation file to download, or wants notes, a document, a spreadsheet or a set of findings turned into slides; not for a quick outline in chat."
---
